...
#Region "Globale Routinen"
    ...
    Public Sub TastKeyUp(e As Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.ShiftKey And Not My.Computer.Keyboard.CapsLock Then
            Call UmschalterWeiss()
        End If
    End Sub
    ...
    Public Sub TastKeyDown(e As Windows.Forms.KeyEventArgs)
        ...
        Try
                    ...
                    If My.Computer.Keyboard.CtrlKeyDown And My.Computer.Keyboard.AltKeyDown Then
                        Select Case e.KeyCode
                            ...
                            Case &H30
                                keyNew = Asc("}")
                        End Select
                    ElseIf My.Computer.Keyboard.CapsLock Or My.Computer.Keyboard.ShiftKeyDown Then
                        Select Case e.KeyCode
                            Case &H30
                                keyNew = Asc("=")
                            Case &H31
            ...
            Else
                Select Case keyNew
                    Case Keys.Shift, Keys.ShiftKey, Keys.LShiftKey, Keys.RShiftKey, Keys.Capital
    ...
    Private Sub Click2Buffer1(TastCode As UInt16)
        ...
        Else
            Call Click2Buffer(TastCode + &H20)
        End If
    End Sub
    ...
    Private Sub Init_PFi()
        ...
        For i = 0 To 3
            If i = COMMON.PFebene Then
                PFbutton1(i).BackColor = Drawing.Color.Red
            Else
                PFbutton1(i).BackColor = Drawing.Color.WhiteSmoke
            End If
        Next i
        j = COMMON.PFebene * 12
        For i = 0 To 11
...
#Region "Umschalter für Shift-Ebenen"
    Private Sub UmschalterWeiss()
        Button66.BackColor = Drawing.Color.WhiteSmoke
        ...
        Button113.Text = "."
        Button114.Text = "/"
    End Sub ' Init_Umschalter
    Private Sub UmschalterRot()
        Button66.BackColor = Drawing.Color.Red
...
#Region "Sondertasten"
    ...
    Private Sub InsMod_Click(sender As Object, e As EventArgs) Handles Button70.Click
        Select Case Button122.BackColor
            Case Drawing.Color.WhiteSmoke
                Button122.BackColor = Drawing.Color.Red
            Case Drawing.Color.Red
                Button122.BackColor = Drawing.Color.WhiteSmoke
        End Select
